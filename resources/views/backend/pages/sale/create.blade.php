                                ...
                                <div class="row my-2 d-flex justify-content-end">
                                    <div class="col-12 col-sm-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="overall_discount_amount">0.00</span>
                                        </div>
                                    </div>
                                </div>
                                {{-- Hidden fields so backend gets a clean type + value regardless of what was typed --}}
                                <input type="hidden" name="overall_discount_type" class="overall_discount_type" value="fixed">
                                <input type="hidden" name="overall_discount_value" class="overall_discount_value" value="0">

                                <div class="row my-2 d-flex justify-content-end">
                                    <div class="col-12 col-sm-3 d-flex justify-content-between align-items-center">
                                        <h6>Grand Total:</h6><h6 class="grand_total">0.00</h6>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    // Calculate subtotal per row, total, overall discount, grand total, due
